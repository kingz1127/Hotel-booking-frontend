...
//     setError(null);
//     try {
//       const data = await getAllRooms(0, 20); // Get more rooms initially
//       console.log("Fetched rooms for display:", data);
      
//       // Take only the first 6 rooms
...
//                   <Card className="p-2 w-[16rem] h-96 hover:shadow-xl transition-shadow duration-300">
//                     {/* Room Image */}
              ...
              <div className="flex gap-4">
                ...
                <button
                  onClick={() => {
                    ...
                    alert(`Booking ${getRoomProperty(selectedRoom, 'roomName')} - Coming Soon!`);
                  }}
