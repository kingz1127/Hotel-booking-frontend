...
//   // Handle edit (optional: you can open a modal pre-filled with room data)
//   function handleEdit(room) {
//     toast.info("Edit feature not implemented yet"); // placeholder
...
//       {/* Add Room Modal */}
//       <div className="mb-6">
//         <AddRoom onRoomAdded={() => setRefreshFlag(!refreshFlag)} />
//       </div>
...
//                   <TableCell>{room.roomDiscount}</TableCell>
//                   <TableCell>{room.roomQuantity}</TableCell>
//                   <TableCell>{room.roomBeds}</TableCell>
//                   <TableCell>{room.roomBaths}</TableCell>
//                   <TableCell>
//                     {room.roomImage && (
//                       <img
//                         src={room.roomImage}
...
//                     </TableCell>
//                     <TableCell>
//                       <span className={`inline-flex items-center justify-center w-8 h-8 rounded-full ${room.roomQuantity > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
//                         {room.roomQuantity}
//                       </span>
//                     </TableCell>
//                     <TableCell>{room.roomBeds}</TableCell>
...
//                             loading="lazy"
//                           />
//                           <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-opacity rounded-md" />
//                         </div>
//                       ) : (
